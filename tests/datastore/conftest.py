...
from controlplane.datastore.types.machine_info import (
    MachineRegistrationInfo as DatastoreMachineRegistrationInfo,
)
...
def machine_registration_info():
    ...
    machine_info_sdk = get_machine_info(machine_info_config)  # type: SdkMachineRegistrationInfo
    machine_info = DatastoreMachineRegistrationInfo(**machine_info_sdk.model_dump())  # type: DatastoreMachineRegistrationInfo
    return machine_info
