...
class MachineInfo(BaseModel):
    ...
    hostname: StrictStr
    __properties: ClassVar[List[str]] = ["machine_id", "last_heartbeat_ts", "registration_ts", "num_cpus", "cpu_description", "host_memory_mb", "num_gpus", "gpu_type", "gpu_memory_mb", "nvidia_driver_version", "hostname"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "last_heartbeat_ts": obj.get("last_heartbeat_ts"),
