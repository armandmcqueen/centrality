...
TOKEN = "dev"
LOGO_SVG = "https://armandmcqueenpublic.blob.core.windows.net/centrality-public/logo-blue.svg"
...
def cluster_view():
    ...
    gpu_count_container.markdown(f"""
    ...
    cpu_container.markdown(gen_cpu_count_container_markdown(len(live_vms)), unsafe_allow_html=True)
...
st.set_page_config(page_icon="https://armandmcqueenpublic.blob.core.windows.net/centrality-public/favicon.ico", page_title="Demo Cluster | Centrality")
st.markdown(
        r"""
        <style>
