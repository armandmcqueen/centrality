...
VM_AGENT_METRIC_CPU_INTERVAL_SECS = 1
VM_AGENT_METRIC_DISK_INTERVAL_SECS = 1
VM_AGENT_METRIC_GPU_INTERVAL_SECS = 1
VM_AGENT_METRIC_MEMORY_INTERVAL_SECS = 1
VM_AGENT_METRIC_NETWORK_INTERVAL_SECS = 1
