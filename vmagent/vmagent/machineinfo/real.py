import psutil
import socket
from vmagent.machineinfo.cpu import get_num_cpus, get_cpu_description
from vmagent.machineinfo.gpu import get_nvidia_gpu_info
...
def get_real_machine_info() -> VmRegistrationInfo:
